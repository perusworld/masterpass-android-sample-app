 ...
 *         &lt;element name="SessionSignature" type="{}NonEmptyString"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {"appId", "appVersion", "appSigningPublicKey", "sessionSignature"})
@XmlRootElement(name = "SessionKeySigningResponse")
public class SwitchSessionKeySigningResponse {
    ...
    @XmlElement(name = "SessionSignature", required = true)
